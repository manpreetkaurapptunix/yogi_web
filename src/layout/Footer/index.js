          ...
          <Grid container spacing={3}>
            ...
            <Grid item lg={2} sm={6} xs={12}>
              <Box className="links_wpr">
                ...
                <Box
                  className="links"
                  onClick={() => router.push("/myClasses")}
                >
                  <Typography className="ftr_link">Classes</Typography>
                </Box>
                {/* <Box className="links" onClick={() => router.replace("/")}>
                  <Typography className="ftr_link">Categories</Typography>
                </Box> */}
                {/* <Box className="links" onClick={() => router.replace("/")}>
                  <Typography className="ftr_link">Pricing</Typography>
                </Box> */}
                <Box
                  className="links"
                  onClick={() => {
                  ...
                  return (
                    <Box
                      ...
                      onClick={() => {
                        item?.val
                          ? dispatch(
                              tempData.updateTempData({ link: item?.val })
                            )
                          : "";
                        router.push(`${item.url}`);
                      }}
                    >
                      <Typography className="ftr_link">{item.name}</Typography>
                    </Box>
                  );
                })}
              </Box> */}
              ...
              <Box className="links_wpr">
                ...
                {isAuthorised && (
                  <Box
                    className="links"
                    onClick={() => {
                      dispatch(tempData.updateTempData({ link: 1 }));
                      router.push(`settings`);
                    }}
                  >
                ...
                <Box
                  className="links"
                  onClick={() => {
                    dispatch(tempData.updateTempData({ link: 7 }));
